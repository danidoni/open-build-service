class Webui::Users::NotificationsController < Webui::WebuiController
  ...
  def index
    @selected_filter = params.permit(notification: [VALID_NOTIFICATION_TYPES + [project: {}, group: {}]])
  ...
  def update
    notification_ids = params.require(:notification).permit(VALID_NOTIFICATION_TYPES + [:update_all, { id: [], project: {}, group: {} }])
